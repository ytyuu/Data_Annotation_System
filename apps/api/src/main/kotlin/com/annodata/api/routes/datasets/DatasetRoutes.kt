package com.annodata.api.routes.datasets

import com.annodata.api.handlers.datasets.AnnotatorDatasetHandler
import com.annodata.api.handlers.datasets.ProviderDatasetHandler
...
import com.annodata.api.service.dataset.AnnotatorDatasetService
...
fun registerDatasetRoutes(authMiddleware: AuthMiddleware?) {
    ...
    routeGroup(requireAuth(authMiddleware), requireRole("provider")) {
        ...
        post("/provider/datasets/{datasetId}/items/import-csv") { ctx -> providerDatasetHandler.importItemsFromCsv(ctx) }
